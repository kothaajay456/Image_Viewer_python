...
image_no_1 = ImageTk.PhotoImage(Image.open("test1.jpg"))
image_no_2 = ImageTk.PhotoImage(Image.open("dove1.jpg"))
image_no_3 = ImageTk.PhotoImage(Image.open("lotus.jpg"))
image_no_4 = ImageTk.PhotoImage(Image.open("lenna.jpg"))
